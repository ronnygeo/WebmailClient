...
onload = function() {
	...
	for (i = 0; i < rows.length; i++) {
        ...
        rows[i].onclick = function() {
			...
			//reply.href = "newmail.php?id="+temp+"&type=reply";
			//var frwd = document.getElementById('frwdbtn');
			//frwd.href = "newmail.php?id="+temp+"&type=forward";
			//$("#replybtn").attr("href", "newmail.php?id="+temp)
			window.location.href="main.php?id=" + this.id;
        }
...
<div id="messagetoolbar" class="toolbar" style="margin-left:-230px;">
	<a class="button checkmail" title="Check for new messages" id="rcmbtn108" href="main.php?id=1" onclick="">Refresh</a>
	<a class="button compose" title="Create a new message" id="rcmbtn109" href="newmail.php" onclick="">Compose</a>
<span class="spacer"></span>
<span class="spacer"></span>
<span class="spacer"></span>
<span class="spacer"></span>
<a class="button reply" title="Reply to sender" id="replybtn" href=<?php //echo "\"newmail.php".($id<>""?$id:"&type=reply")."\""; 
echo "'newmail.php".$id."&type=reply'";
?> onclick="">Reply</a>
...
<a class="button forward" title="Forward the message" id="frwdbtn" href=<?php echo "'newmail.php".$id."&type=forward'"; ?> onclick="">Forward</a>
<a class="button delete" title="Delete message" id="rcmbtn113" href=<?php echo "\"main.php".($id<>""?$id."&act=del":"")."\""; ?> onclick="">Delete</a>


<a class="button print" id="rcmbtn118" href="lib/print.php?id=<?php echo $_GET["id"];?>" target="_blank"><span class="icon print">Print</span></a>
...
<table id="messagelist" name="messagelist" class="records-table sortheader"><thead><tr>
...
<div id="mailpreviewframe" style="height:100%;">
<!--<iframe name="messagecontframe" id="messagecontframe" style="width:100%; height:100%" frameborder="0" src ="lib/EmailContent.php" >
...
<?php
	if($_SERVER["REQUEST_METHOD"] == "GET"){
		if($_GET["id"] != "")
		{
			echo "<iframe name=\"messagecontframe\" id=\"messagecontframe\" style=\"width:100%; height:95%; overflow:none;margin-top:-20px;\" frameborder=\"0\" src =\"lib/EmailContent.php?id=".$_GET["id"]."\" > ";
			//$content ="<html><head><title></title></head><body>Hello world.".$_GET["id"]. "</body></html>";
			//print_r( $IMAP->FetchMessage($_GET["id"]));
			//echo "<script type=\"text/javascript\"> var ifr = document.getElementById('messagecontframe').contentWindow.document; ";
			//echo "ifr.open();ifr.write('".$content."');ifr.close();";
			echo "</iframe>";
		  ...
		  if(isset( $_GET["act"])){
				...
				echo "<iframe name=\"messagecontframe\" id=\"messagecontframe\" style=\"width:100%; height:100%\" frameborder=\"0\" src=\"styles/placeholder.html\"> ";	
				echo "</iframe>";
		}

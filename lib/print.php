...
<td class="header from"><span class="adr"><a href=<?php echo "\"".$fromEmail. "\""; ?> onclick="" title="<?php echo "\"".$fromEmail. "\""; ?>" class="rcmContactAddress"><?php echo $from . " " . $fromEmail; ?></a><a href="#add" onclick="" title="Add to address book" class="rcmaddcontact"></a></span></td>
</tr>
<tr><td class="header-title">To</td>
<td class="header to"><span class="adr"><a href=<?php echo "\"".$To. "\""; ?> onclick="" title="<?php echo "\"".$To. "\""; ?>" class="rcmContactAddress"><?php echo $To; ?></a><a href="#add" onclick="" title="Add to address book" class="rcmaddcontact"></a></span></td>
</tr>
...
<div id="messagebody"><div class="message-htmlpart"><!-- html ignored --><!-- head ignored --><!-- meta ignored --><div class="rcmBody" style="font-family: Verdana,Geneva,sans-serif;">
<?php echo $body; ?>
</div>
<!--</div> for leftcol-->
</div><!--messagecontent -->

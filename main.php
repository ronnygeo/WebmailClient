...
<div id="messagetoolbar" class="toolbar" style="margin-left:-230px;">
	<a class="button checkmail" title="Check for new messages" id="rcmbtn108" href="main.php?id=" onclick="">Refresh</a>
...
<?php
	if($_SERVER["REQUEST_METHOD"] == "GET"){
		if($_GET["id"] != "")
		{
			echo "<div id='mailpreviewframe' style='height:100%;'>";
		  ...
		  if(isset( $_GET["act"])){
				...
				echo "<iframe style=\"width:100%; height:100% \" frameborder=\"0\" src=\"styles/placeholder.html\"> ";	
				echo "</iframe>";

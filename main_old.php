...
<div id="topline">
	...
	<div class="topright">
			...
			<span class="username">shakil@shakilkumar.com</span>
...
<div id="topnav">
	...
	<a class="button-settings" id="rcmbtn106" href="./?_task=settings" onclick=""><span class="button-inner">Settings</span></a>
...
<div id="messagetoolbar" class="toolbar" style="margin-left:-230px;">
	...
	<a class="button compose" title="Create a new message" id="rcmbtn109" href="newemail.php" onclick="">Compose</a>
...
<div id="replyallmenu" class="popupmenu">
	<ul class="toolbarmenu">
		<li><a class="replyalllink" id="rcmbtn116" href="#" onclick="">Reply all</a></li>
		<li><a class="replylistlink" id="rcmbtn117" href="#" onclick="">Reply list</a></li>
...
<!--<option value="HEADER X-PRIORITY 1">Priority: Highest</option>
<option value="HEADER X-PRIORITY 2">Priority: High</option>
<option value="NOT HEADER X-PRIORITY 1 NOT HEADER X-PRIORITY 2 NOT HEADER X-PRIORITY 4 NOT HEADER X-PRIORITY 5">Priority: Normal</option>
<option value="HEADER X-PRIORITY 4">Priority: Low</option>
<option value="HEADER X-PRIORITY 5">Priority: Lowest</option>-->
</select>
...
<tbody >
<tr id ="TR1"><td>Shakil Kumar</td><td>Ronnie Mathew</td><td>03/03/2013 10:10:10</td><td>Let's Meet for Project</td><td>10.00kb</td><td></td></tr>
...
<iframe name="messagecontframe" id="messagecontframe" style="width:100%; height:100%" frameborder="0" src="styles/placeholder.html"></iframe>
</div>

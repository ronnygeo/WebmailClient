...
onload = function() {
	...
	for (i = 0; i < rows.length; i++) {
        ...
        rows[i].onclick = function() {
			...
			reply.href = "newmail.php?id="+temp;
...
<div id="messagetoolbar" class="toolbar" style="margin-left:-230px;">
	<a class="button checkmail" title="Check for new messages" id="rcmbtn108" href="#" onclick="window.location.reload();">Refresh</a>
	<a class="button compose" title="Create a new message" id="rcmbtn109" href="newmail.php" onclick="">Compose</a>
<span class="spacer"></span>
<span class="spacer"></span>
<span class="spacer"></span>
<span class="spacer"></span>
<a class="button reply" title="Reply to sender" id="replybtn" href=<?php echo "\"newmail.php".($id<>""?$id:"")."\""; ?> onclick="">Reply</a>
...
<?php
	if($_SERVER["REQUEST_METHOD"] == "GET"){
		if($_GET["id"] != "")
		{
			echo "<iframe name=\"messagecontframe\" id=\"messagecontframe\" style=\"width:100%; height:100%\" frameborder=\"0\" src =\"lib/EmailContent.php?id=".$_GET["id"]."\" > ";
			//$content ="<html><head><title></title></head><body>Hello world.".$_GET["id"]. "</body></html>";
			//print_r( $IMAP->FetchMessageTest($_GET["id"]));

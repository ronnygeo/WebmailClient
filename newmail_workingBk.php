 ...
 $allowedTags.='<li><ol><ul><span><div><br><ins><del>'; 
       ...
       if($_SERVER["REQUEST_METHOD"] == "GET"){
		   ...
		   //echo $_GET["id"];
			...
			$IMAP = new IMAPClient("mail.shakilkumar.com","143",$_SESSION["UserID"],$_SESSION["Password"]);
		  $IMAP->imap_connect();
		  //echo "IMAP Connected";
		  $IMAP->Authenticate($_SESSION["UserID"],$_SESSION["Password"]);
		  $IMAP->SelectFolder("INBOX");
		  $msg=$IMAP->FetchMessageTest($_GET["id"]);
		  //echo $msg;
		  //echo $msg[0].$msg[1];
		  $to=$msg["from"];
...
<div id="mailtoolbar" class="toolbar">
	...
	<a class="button close" id="rcmbtn102" href="main.php?id=1" onclick="">Dispose</a>

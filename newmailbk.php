...
<?php
 ...
 $allowedTags.='<li><ol><ul><span><div><br><ins><del>'; 
	...
	include 'lib/SMTPClass.php';
	 if($_SERVER["REQUEST_METHOD"] == "POST")
      {
		  print_R(htmlspecialchars($_POST['to']));
		  echo($_POST['subject']."\n\r");
		  print_R(htmlspecialchars($_POST['_message']));
		  
		  $SMTP = new SMTPClient($_SESSION['MailServer'],$_SESSION['Port'],$_SESSION['UserID'],$_SESSION['Password'],$_SESSION['UserID'],htmlspecialchars($_POST['to']),$_POST['subject'],htmlspecialchars($_POST['_message']));
		 
		//echo($_POST['to'],"<BR/>", $_POST['subject'], "<BR/>", $_POST['_message']);
...
<div id="mailtoolbar" class="toolbar">
	...
	<a class="button send" title="Send now" id="rcmbtn103" href="#" onclick="valSend();return false;">Send</a>
    	<span class="spacer"></span>
...
bcc.add( Validate.Email );
    ...
    <tr>
		...
		<td class="editfield"><input name="subject" id="compose-subject" tabindex="4" value="" type="text"></td>
	</tr>
</tbody>
</table>
